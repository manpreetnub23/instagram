...
// 									className="mt-2 p-1 text-sm text-white bg-red-500 w-20"
// 								>
// 									Log out
// 								</button>
// 							)}
...
// 					<button
// 						onClick={handleLogout}
// 						className="w-full bg-gradient-to-r from-[#315d94] to-[#6191c2] text-white py-1  text-center text-lg shadow-md"
// 					>
// 						LOG OUT
// 					</button>
// 				</div>
